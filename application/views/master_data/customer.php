   ...
   <div class="container-fluid">
    ...
    <form action="<?= base_url('masterdata/customer'); ?>" method="post">
          <div class="row">
          <div class="col-sm-1">
            ...
            <table class="table table-hover table-responsive" style="font-size: 12px;">
				        ...
				        <tbody>
				        	<?php 
					          ...
					          <tr>
					            <td><?= $j ?></td>
					            <td><?= $cust['cust_nama']; ?></td>
					            <td><?= $cust['cust_no_telp']; ?></td>
					            <td><?= $cust['cust_alamat']; ?></td>
					            <td><a class="btn btn-danger btn-sm" href="<?= base_url('masterdata/hapusCustomer/') . $cust['cust_id']; ?>">hapus</a>
					            </td>
